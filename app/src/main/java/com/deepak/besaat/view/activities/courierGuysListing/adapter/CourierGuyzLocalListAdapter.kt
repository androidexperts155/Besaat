...
class CourierGuyzLocalListAdapter(
    var activity: Activity,
    var courierServiceProviderList: MutableList<Courier>,
    var deliveryType: String
) :
    ListAdapter<Courier, CourierGuyzLocalListAdapter.ViewHolder>(StoreDetailDiffCallback()) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        var inflater = LayoutInflater.from(parent.context)
            ...
            binding = DataBindingUtil.inflate<AdapterCourierGuyzLocalBinding>(
                inflater,
                R.layout.adapter_courier_guyz_local,
                parent,
                false
            )
//        } else {
...
//            intent.putExtra("data", getItem(position))
    ...
    class ViewHolder(binding: AdapterCourierGuyzLocalBinding) :
        RecyclerView.ViewHolder(binding.root) {
        var binding: AdapterCourierGuyzLocalBinding = binding
    }
