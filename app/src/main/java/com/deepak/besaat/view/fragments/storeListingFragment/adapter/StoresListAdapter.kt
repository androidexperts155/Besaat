...
class StoresListAdapter(
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        Log.e(
            "RadiusValue",
            "alt value and long value " + sharedPref.getString(Constants.latChanged) + "  " + sharedPref.getString(
                Constants.longChanged
            ) + "  " + storeList.get(position).latitute + "   " + storeList.get(
                position
            ).longitute!!.toDouble()
        )
        if (sharedPref.getString(Constants.latChanged).equals("") && sharedPref.getString(Constants.longChanged).equals(
            ...
            radiusValue = CalculationByDistance(
                ...
                LatLng(
                    storeList.get(position).latitute!!.toDouble(),
                    storeList.get(position).longitute!!.toDouble()
                )
            )
        } else {
            radiusValue = CalculationByDistance(
        ...
        Log.e("RadiusValue", "radius value is " + radiusValue)
        ...
        } else if (radiusValue.toString().length > 0) {
        ...
        //  ImageFetchMethod(profilePicUrl)

        Log.e("profilePic", " profile pic url is " + profilePicUrl)
        Glide.with(activity)
            .load(profilePicUrl)
        ...
        /*   }else{
               ...
               holder.circularImage.setImageDrawable(null);
           }*/
        /* placeholder(R.drawable.ic_profile_placeholder)
             .error(R.drawable.ic_profile_placeholder)
             .skipMemoryCache(true) //2
             .diskCacheStrategy(DiskCacheStrategy.NONE)*/
        holder.topContrain.setOnClickListener(object : View.OnClickListener {
    ...
    private fun ImageFetchMethod(url: String) {
