package com.deepak.besaat.view.activities.newRequestCourier
...
import com.deepak.besaat.databinding.ActivityNewRequestCourierBinding
...
import kotlinx.android.synthetic.main.activity_new_request_courier.*
import org.koin.android.ext.android.inject
import java.text.SimpleDateFormat
import java.util.*

class NewRequestCourier : BaseActivity() {
    lateinit var binding: ActivityNewRequestCourierBinding
    ...
    fun init() {
        ...
        viewModel.requestType.set("3") // 3 for Local Courier
...
//                )
    ...
    private fun intentToNextPaymentScreen(data: NewServiceRequestPojo) {
        var int = Intent(this@NewRequestCourier, PaymentDetailsStoreActivity::class.java)
    ...
    private fun datePickerDialog() {
        ...
        val datePickerDialog = DatePickerDialog(
            this@NewRequestCourier, date, myCalendar
